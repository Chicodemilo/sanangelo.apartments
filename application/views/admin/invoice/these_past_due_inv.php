<div class="wrapper">
		...
		<?php 
			...
			foreach ($past_due as $key => $value) {
				echo "<tr>";
					...
					echo "</td>";
					echo "<td class='inv_bg_".$row_flipper."'>";
						echo "<a href='".base_url()."admin/this_inv_edit/".$value['inv_number']."/"."past_due"."/"."past_due"."'>EDIT</a>";
					echo "</td>";
					echo "<td class='inv_bg_".$row_flipper."'>";
						echo "<a href='".base_url()."admin/delete_this_invoice/".$value['inv_number']."/"."past_due"."/"."past_due"."'>DELETE</a>";
					echo "</td>";
					echo "<td class='inv_bg_".$row_flipper."'>";
						echo "<a href='".base_url()."admin/send_this_invoice/".$value['inv_number']."/past_due'>SEND</a>";
					echo "</td>";
				echo "</tr>";
				echo "<tr>";
	...
	<table>
		<tbody>
			<tr>
				<td>
					<a href="<?php echo base_url(); ?>admin/send_past_due" title="SEND PAST DUE ONLY">SEND ALL PAST DUE</a>
				</td>
			</tr>
		</tbody>
	</table>
