		...
		<?php 
			...
			foreach ($advertiser_inv as $key => $value) {
				echo "<tr>";
					...
					echo "</td>";
					echo "<td class='inv_bg_".$row_flipper."'>";
						echo "<a href='".base_url()."admin/this_inv_edit/".$value['inv_number']."/"."this_adv"."/".$value['apt_id']."'>EDIT</a>";
					echo "</td>";
					echo "<td class='inv_bg_".$row_flipper."'>";
						echo "<a href='".base_url()."admin/delete_this_invoice/".$value['inv_number']."/"."this_adv"."/".$value['apt_id']."'>DELETE</a>";
					echo "</td>";
					echo "<td class='inv_bg_".$row_flipper."'>";
						echo "<a href='".base_url()."admin/send_this_invoice/".$value['inv_number']."/"."this_adv"."/".$value['apt_id']."'>SEND</a>";
					echo "</td>";
				echo "</tr>";
				echo "<tr>";
