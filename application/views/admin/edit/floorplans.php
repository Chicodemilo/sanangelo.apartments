<div class="hours_box">
		<div class="hours_head">
			FLOOR PLANS : <?php echo $apt_name; ?>
		</div>
		<form action="<?php echo base_url() ?>admin/submit_floorplans/<?php echo $apt_id; ?>" method="post">
		<?php 
			$csrf = array(
		...
		<div class="floorplan_table_b_div">
			...
			foreach ($floorplans as $key => $value) {
				...
				if($value['floorplan_pic'] == ''){
					echo "<td rowspan='3'><a href='".base_url()."admin/upload_this/".$apt_id."/".$value['id']."'>Upload Diagram</a></td>";
				}else{
					echo "<td rowspan='3'><img src='".base_url()."images/floorplans/".$apt_id."/".$value['id']."/".$value['floorplan_pic']."' alt='".$value['name']."' width='100px'></td>";
				}
				
				echo "</tr><tr>";
				echo "<td colspan='5'>".$value['description']."</td>";
				echo "</tr><tr>";
				echo "<td colspan='3'><a href='".base_url()."admin/edit_floorplan/".$apt_id."/".$value['id']."'>Edit</a></td><td colspan='2'><a href='".base_url()."admin/delete_floorplan/".$apt_id."/".$value['id']."'>Delete</a></td>";
