<div class="specials_box">
		<div class="hours_head">
			SPECIAL <?php echo $apt_name ?>
		</div>
		<form action="<?php echo base_url() ?>admin/submit_specials/<?php echo $apt_id ?>" method="post">
		<?php 
			$csrf = array(
		...
		<div class="specials_table_b_div">
			...
			foreach ($specials as $key => $value) {
				...
				echo "</tr>";
				echo "<tr><td colspan='4'><a href='".base_url()."admin/delete_special/".$apt_id."/".$value['id']."' id='noblock'>delete special</a></td></tr>";
