	...
	<form action="<?php echo base_url(); ?>edit/submit_picture_edits/<?php echo $picture[0]['id']; ?>" method="post">
		...
		<table id="user_edit">
			...
			<tr>
				<td colspan="2"><img src="<?php echo base_url(); ?>images/pictures/<?php echo $this->session->userdata('apt_id').'/'.$picture[0]['id']; ?>/<?php echo $picture[0]['name']; ?>" alt="<?php echo $picture[0]['caption']; ?>" width="100%"></td>
			</tr>
			<tr>
