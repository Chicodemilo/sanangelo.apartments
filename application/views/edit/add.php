...
echo "<td><input type='text' name='City' id='City' style='width:90%' required value='".MARKET."' tabindex=9></td>";
echo "<td><input type='text' name='State' id='State' style='width:90%' required value='".STATE."' tabindex=10></td>";
