...
<div class="inner_main_bg">
	...
	<?php 
		if($background_data['takeover_mobile'] != 'N' && background_data != 'N'){
	...
	<div class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
			...
			<a href="<?php echo base_url(); ?>texas/apartment/<?php echo $property_search_name ?>/<?php echo $apt_id ?>" itemtype="http://schema.org/ListItem" itemprop="item">
				<span itemprop="name"><?php echo $property_name; ?></span>
				...
				<div class="apt_website">
					<?php 
						if($free == 'N'){
							...
							if($property_website != ""){
								echo "<hr>";
								echo "<a href='http://".$property_website."'  rel='nofollow' target='blank'>";
					...
					<?php 
						if($free == 'N'){
							if($property_management_url != ""){
								echo "<hr>";
								echo "<a href='http://".$property_management_url."' rel='nofollow' target='blank'>";
							}
